...
import './WordLaddersResults.scss';

const bem = defineBlock('WordLaddersResults');

const WordLaddersResults = ({
  word1,
  word2,
  excludedWords,
  listSize,
...
export default WordLaddersResults;
